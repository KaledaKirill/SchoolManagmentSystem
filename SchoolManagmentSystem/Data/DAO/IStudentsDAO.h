...
public:
    ...
    virtual void addStudent(const QString& studentName, const QString& groupName) = 0;
    virtual void deleteStudent(const QString& studentName, const QString& groupName) = 0;
