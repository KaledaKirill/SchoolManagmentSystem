...
void TeacherWindowGroupsPage::addGroup()
{
    ...
    if (!groupName.isEmpty())
    {
        ...
        {
            QMessageBox::warning(0, "Неуспешная операция", "Видимо уже существует класс с таким именем, добавление нового невозможно.");
        }
    }
...
void TeacherWindowGroupsPage::addSubject()
{
    ...
    if (!subjectName.isEmpty())
    {
        ...
        {
            QMessageBox::warning(0, "Неуспешная операция", "Видимо уже существует предмет с таким именем, добавление нового невозможно.");
        }
    }
}
...
void TeacherWindowGroupsPage::addStudent()
{
    ...
    if (!studentName.isEmpty())
    {
        ...
        {
            QMessageBox::warning(0, "Неуспешная операция", "Видимо уже существует ученик с таким ФИО, добавление нового невозможно.");
        }
    }
}
